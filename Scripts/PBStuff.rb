class PBStuff
  ...
  DANCEMOVE = [
    ...
    PBMoves::PYRETICRITUAL,PBMoves::SWANDIVE,PBMoves::RITEOFSPRING
  ]
  BULLETMOVE = [
  ...
  PIERCINGMOVE = [
    ...
    PBMoves::THREEFOLDSTRIKE,PBMoves::EQUINOXHORN
  ]
  BLUDGEONINGMOVE = [
  ...
  BOMBMOVE = [
    ...
    PBMoves::ZAPCANNON,PBMoves::UNSTABLEMATTER,PBMoves::THOUGHTBOMB,PBMoves::NEEDLEBLAST
  ]
  BALLMOVE = [
  ...
  LIGHTMOVE = [
    ...
    PBMoves::LIGHTOFRUIN,PBMoves::SEARINGSUNRAZESMASH,PBMoves::LIGHTTHATBURNSTHESKY,
    PBMoves::TERABLAST,PBMoves::TERASTARSTORM
  ]
  BEAMMOVE = [
    ...
    PBMoves::LIGHTOFRUIN,PBMoves::MENACINGMOONRAZEMAELSTROM,
    ...
    PBMoves::SCRUTINIZE,PBMoves::REDSUNZENITH,PBMoves::SLOUGHRAY
  ]
  PINNINGMOVE = [
  ...
  SOUNDMOVE = [
    ...
    PBMoves::CIRCADIANRHYTHM,PBMoves::FAERIEFIB,PBMoves::FRACTURE
  ]
  WHIPMOVE = [
  ...
  MOMENTUMMOVE = [
    ...
    PBMoves::FEINT,PBMoves::DEFENSECURL,PBMoves::FLAMEWHEEL,PBMoves::RAPIDSPIN,
    PBMoves::MORTALSPIN,PBMoves::BIDE
  ]
  SCENTMOVE = [
  ...
  STATBOOSTINGATTACKMOVE = [
    PBMoves::POWERUPPUNCH,PBMoves::CHARGEBEAM,PBMoves::FLAMECHARGE,
    PBMoves::METEORMASH,PBMoves::STEELWING,PBMoves::ANCIENTPOWER,
    PBMoves::SILVERWIND,PBMoves::OMINOUSWIND,PBMoves::FELLSTINGER,
    (defined?(PBMoves::TRUMPETTUNE) ? PBMoves::TRUMPETTUNE : nil)
  ].compact
  BLINKMOVE = []
  TRANSPORTMOVE = [
    PBMoves::FLY,PBMoves::DIG,PBMoves::TELEPORT,PBMoves::PHANTOMFORCE,
    PBMoves::SHADOWFORCE
  ]
